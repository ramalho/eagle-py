...
# Changed: $LastChangedBy: gustavo $ at $LastChangedDate: 2006-01-07 14:15:24 -0200 (Sat, 07 Jan 2006) $
...
try:
    ...
    sys.stderr.writelines(
        ("Missing module: ", str(e), "\n",
         "This module is part of PyQt4 (http://www.riverbankcomputing.co.uk/pyqt/).\n",
         ))
    sys.exit(-1)
...
class _Table(QtGui.QWidget):
    ...
    def __init__(self, parent, id, children, horizontal=False):
        self.id = id
	...
	self._layout = QtGui.QBoxLayout(direction, self)
...
class _Panel(QtGui.QScrollArea):
    ...
    def __setup_gui__(self):
        self.setHorizontalScrollBarPolicy(self._hscrollbar_policy)
...
class PreferencesDialog(_EGWidget, AutoGenId):
    ...
    def __setup_gui__(self):
        ...
        self._tab = _Table(self._sw, self.id, self.children)
...
class Group(_EGWidget):
    ...
    def __setup_gui__(self):
        ...
        self._contents = _Table(self._frame, id=("%s-contents" % self.id),
